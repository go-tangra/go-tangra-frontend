...
export const LucideShieldX = createIconifyIcon('lucide:shield-x');
export const LucideShield = createIconifyIcon('lucide:shield');
...
export const LucideFolder = createIconifyIcon('lucide:folder');
...
export const LucideNetwork = createIconifyIcon('lucide:network');
export const LucideHash = createIconifyIcon('lucide:hash');
export const LucideGitBranch = createIconifyIcon('lucide:git-branch');

// Bitwarden import/export icons
export const LucideUpload = createIconifyIcon('lucide:upload');
export const LucideFileJson = createIconifyIcon('lucide:file-json');

// Paperless icons
export const LucideFile = createIconifyIcon('lucide:file');
export const LucideFileText = createIconifyIcon('lucide:file-text');
export const LucideFiles = createIconifyIcon('lucide:files');
export const LucideFolderPlus = createIconifyIcon('lucide:folder-plus');
